    ...
    function __setOptions($params) {
        ...
        if (isset($params['form']) && $params['form'] !== false) {
            if (isset($params['form']['id'])) {
                $this->options['form']['id'] = $params['form']['id'];
            }
            if (isset($params['form']['name'])) {
                $this->options['form']['name'] = $params['form']['name'];
            }
            if (isset($params['form']['method'])) {
                $this->options['form']['method'] = $params['form']['method'];
            }
            if (isset($params['form']['action'])) {
                $this->options['form']['action'] = $params['form']['action'];
            }
        } else {
        ...
        if (isset($params['input'])) {
            if (isset($params['input']['id'])) {
                $this->options['input']['id'] = $params['input']['id'];
            }
            if (isset($params['input']['name'])) {
                $this->options['input']['name'] = $params['input']['name'];
            }
        ...
        if (isset($params['name'])) {
            if (isset($params['name']['id'])) {
                $this->options['name']['id'] = $params['name']['id'];
            }
            if (isset($params['name']['name'])) {
                $this->options['name']['name'] = $params['name']['name'];
            }
        }

        /* set styles elements */
        if (isset($params['styles'])) {
            if (isset($params['styles']['div'])) {
                $this->styles['div'] = $params['styles']['div'];
            }
            if (isset($params['styles']['input'])) {
                $this->styles['input'] = $params['styles']['input'];
            }
            if (isset($params['styles']['image'])) {
                $this->styles['image'] = $params['styles']['image'];
            }
            if (isset($params['styles']['name'])) {
                $this->styles['name'] = $params['styles']['name'];
            }
        }

        /* set the image */
        if (isset($params['image'])) {
            $this->options['image'] = $params['image'];
        }
    }
