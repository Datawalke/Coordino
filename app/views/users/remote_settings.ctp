...
<div class="detailed_inputs">
	<div>
		...
		<?php echo $settings['0']['Setting']['value'];?>
	</div>
	<br/>
<form action="?" method="post">
	...
	<div>
		...
		<input type="text" name="data[2][Setting][value]" value="<?php echo $settings['2']['Setting']['value'];?>" />
	</div>
	<br/>
	<div>
		<h3>Remote Authentication Logout URL:</h3>
		<input type="text" name="data[3][Setting][value]" value="<?php echo $settings['3']['Setting']['value'];?>" />
	</div>
	<br/>
	<div class="submit">
