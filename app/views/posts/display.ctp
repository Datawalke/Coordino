    ...
    <div class="list_question wrapper">
        ...
        <div class="wrapper list_detail_text">
            <div class="list_title  wrapper">
                <?php
                echo $html->link(
                        $question['Post']['title'], '/questions/' . $question['Post']['public_key'] . '/' . $question['Post']['url_title']
                );
                ?>
            </div>
            <div class="wrapper">
                <div style="float: right;">
                    <div class="thumb_with_border">
                        ...
                        <?php
                        echo $html->link($thumbnail->get(array(
                    ...
                    <div style="float: left; line-height: .9;">
                        <div>
                            <?php
                            echo $html->link(
                                    $question['User']['username'], '/users/' . $question['User']['public_key'] . '/' . $question['User']['username']
                            );
                            ?> 
