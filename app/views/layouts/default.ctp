                        ...
                        <ul class="tabs">
                            ...
                            <?php if (!$session->check('Auth.User.id')) { ?>
                                <li>
                                    <?php
                                    echo $html->link(
                                            __('login', true), array('controller' => 'users', 'action' => 'login')
                                    );
                                    ?>
                                </li>
                            <?php } ?>
                            <?php if (!$session->check('Auth.User.id') || $session->read('Auth.User.registered') == 0) { ?>
                                <li>
                                    <?php
                                    echo $html->link(
                                            __('register', true), array('controller' => 'users', 'action' => 'register')
                                    );
                                    ?>
                                </li>
                            <?php } ?>
                            <li>
                                <?php
                                echo $html->link(
                                        __('about', true), array('controller' => 'pages', 'action' => 'display', 'about')
                                );
                                ?>
                            </li>
                            <?php if ($session->read('Auth.User.id')) { ?>
                                <li>
                                    <?php
                                    echo $html->link(
                                            __('settings', true), '/users/settings/' . $session->read('Auth.User.public_key')
                                    );
                                    ?>
                                </li>
                            <?php } ?>
                            ...
                            <?php if ($session->check('Auth.User.id') && $session->read('Auth.User.permission') != '') { ?>
                                <li>
                                    <?php
                                    echo $html->link(
                                            __('admin', true), array('controller' => 'users', 'action' => 'admin')
                                    );
                                    ?>
                                    <ul>
                                        <li>
                                            <?php
                                            echo $html->link(
                                                    ucfirst(__('settings', true)), array('controller' => 'users', 'action' => 'admin')
                                            );
                                            ?>
                                        </li>
                                        <li>
                                            <?php
                                            echo $html->link(
                                                    ucfirst(__('Flagged Posts', true)), array('controller' => 'users', 'action' => 'flagged')
                                            );
                                            ?>
                                        </li>
                                        <li>
                                            <?php
                                            echo $html->link(
                                                    ucfirst(__('User Management', true)), array('controller' => 'users', 'action' => 'admin_list')
                                            );
                                            ?>
                                        </li>
                                        <li>
                                            <?php
                                            echo $html->link(
                                                    ucfirst(__('Blacklist', true)), array('controller' => 'users', 'action' => 'list_blacklist')
                                            );
                                            ?>
                                        </li>
                                        <li>
                                            <?php
                                            echo $html->link(
                                                    ucfirst(__('Remote Settings', true)), array('controller' => 'users', 'action' => 'remote_settings')
                                            );
                                            ?>
                                        </li>
                                    </ul>
                            ...
                            <?php if ($session->check('Auth.User.id') && $session->read('Auth.User.registered') == 1) { ?>
                                <li>
                                    <?php
                                    echo $html->link(
                                            __('logout', true), array('controller' => 'users', 'action' => 'logout')
                                    );
                                    ?>
                                </li>
                            <?php } ?>
                ...
                <div class="wrapper">
                    ...
                    <ul class="tabs" style="float: right;">
                        <li>
                            <?php
                            echo $html->link(
                                    __('Ask a question', true), array('controller' => 'posts', 'action' => 'ask')
                            );
                            ?>
                        </li>
                    </ul>
            ...
            <div id="body" class="wrapper">
                ...
                <div id="sidebar" class="wrapper">
                    ...
                    if (isset($admin) && $admin):
                        ?>
                        <?php
                        echo $html->link($html->image('icons/plugin_edit.png', array('alt' => __('Edit', true))) . __('add widgets to this page', true), '/widgets/add' . $html->url(null, false), array('escape' => false)
                        );
                        ?>
                    <?php endif; ?>
