...
/**
 * Static method handler for PHP 8.3 compatibility
 * Delegates static calls to the singleton instance
 */
	static function __callStatic($method, $args) {
		...
		trigger_error("Call to undefined method Cache::$method()", E_USER_ERROR);
	}
}
